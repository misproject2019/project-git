...
"}")
        ...
        self.add_label.setGeometry(QtCore.QRect(140, 230, 212, 28))
        font = QtGui.QFont()
        ...
        self.tag_label.setGeometry(QtCore.QRect(140, 280, 212, 28))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
        ...
        self.label_6.setGeometry(QtCore.QRect(30, 170, 101, 41))
...
"color: rgb(255, 255, 255);")
        ...
        self.pn_label.setGeometry(QtCore.QRect(140, 120, 212, 28))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
        ...
        self.name_label.setGeometry(QtCore.QRect(140, 70, 212, 28))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
        ...
        self.label_8.setGeometry(QtCore.QRect(30, 330, 40, 28))
        font = QtGui.QFont()
        font.setFamily("華康粗圓體")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_8.setStyleSheet("color: rgb(230, 51, 76);")
        self.label_8.setObjectName("label_8")
        self.label_5 = QtWidgets.QLabel(self.frame)
        self.label_5.setGeometry(QtCore.QRect(30, 120, 101, 41))
        font = QtGui.QFont()
        font.setFamily("華康粗圓體")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label_4.setGeometry(QtCore.QRect(30, 230, 80, 28))
        font = QtGui.QFont()
        font.setFamily("華康粗圓體")
        font.setPointSize(12)
        font.setBold(False)
        ...
        self.label.setGeometry(QtCore.QRect(130, 20, 101, 33))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        ...
        self.label_2.setGeometry(QtCore.QRect(30, 380, 301, 171))
        self.label_2.setText("")
        self.label_2.setPixmap(QtGui.QPixmap("menu.jpg"))
        ...
        self.time_label.setGeometry(QtCore.QRect(140, 170, 212, 28))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
        ...
        self.label_7.setGeometry(QtCore.QRect(30, 280, 81, 31))
        font = QtGui.QFont()
        font.setFamily("華康粗圓體")
        font.setPointSize(12)
        font.setBold(False)
...
"color: rgb(255, 255, 255);")
        ...
        self.score_label.setGeometry(QtCore.QRect(140, 330, 212, 28))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
    ...
    def retranslateUi(self, InfoWindow):
        ...
        self.label_8.setText(_translate("InfoWindow", "評分"))
        self.label_5.setText(_translate("InfoWindow", "連絡電話"))
        self.label_4.setText(_translate("InfoWindow", "店家地址"))
        self.label.setText(_translate("InfoWindow", "店家資料"))
        self.label_3.setText(_translate("InfoWindow", "店家名稱"))
        self.label_7.setText(_translate("InfoWindow", "標籤"))
