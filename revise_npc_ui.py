...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_submit.setGeometry(QtCore.QRect(60, 530, 93, 41))
        font = QtGui.QFont()
        ...
        self.label_7.setGeometry(QtCore.QRect(110, 30, 141, 51))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        ...
        self.pushButton_cancel.setGeometry(QtCore.QRect(200, 530, 101, 41))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
        self.pushButton_cancel.setFont(font)
        self.pushButton_cancel.setObjectName("pushButton_cancel")
        self.radioButton_boy = QtWidgets.QRadioButton(self.centralwidget)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("boy.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.radioButton_boy.setIcon(icon)
        self.radioButton_boy.setIconSize(QtCore.QSize(111, 111))
        self.radioButton_boy.setObjectName("radioButton_boy")
        self.radioButton_girl = QtWidgets.QRadioButton(self.centralwidget)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("girl.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.radioButton_girl.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("other.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.radioButton_other.setIcon(icon2)
