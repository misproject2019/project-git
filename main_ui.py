...
"}")
        ...
        self.pushButton_task.setGeometry(QtCore.QRect(10, 100, 121, 37))
        font = QtGui.QFont()
        font.setFamily("Yu Gothic UI")
        font.setPointSize(12)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_discount.setText(_translate("Dialog", "   折  價  卷"))
        self.pushButton_friend.setText(_translate("Dialog", "   好        友"))
        self.pushButton_shop.setText(_translate("Dialog", "   商        城"))
        self.pushButton_task.setText(_translate("Dialog", "   任務列表"))
        self.pushButton_favorite.setText(_translate("Dialog", "   收  藏  夾"))
