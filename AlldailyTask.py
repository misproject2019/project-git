# -*- coding: utf-8 -*-
"""
Created on Wed Aug 21 22:36:22 2019
...
import AlldailyTask_ui
import showTask


class alldailyWindow(QWidget, AlldailyTask_ui.Ui_Form):
    def __init__(self, parent=None):
        super(alldailyWindow, self).__init__()
        self.setupUi(self)
